...
<div className="d-flex gap-2 mt-4 mb-3 shadow-sm">
  ...
  <img src={usage} class="img" alt="Responsive image"  style={{width:'150px',height:'150px'}} />
    ...
    <div className="card-text ps-3 ms-2">
      <h5>Usage</h5>
    Ampla Uganda is a powerful tool that helps businesses of all sizes to track and manage their hardware inventory. With our system, you can track inventory levels in real time, simplify stock replenishment, monitor customer debts, generate reports on inventory levels, sales, and more. Ampla Uganda is easy to use and can be customized to meet the specific needs of your business. Whether you're a small hardware store or a large enterprise, our system can help you improve inventory management and profitability.
    </div>
...
<div className="d-flex gap-2 mt-4 mb-3 shadow-sm">
  ...
  <img src={fit} className="img" alt="Responsive image"  style={{width:'150px',height:'150px'}} />
    ...
    Ampla Uganda is a perfect solution for businesses which deal in tangible items that may or may not differ in terms of names, types, colors, brands and many more.<br/> It is not a good fit for businesses dealing in services or intangible items unless you are very sure it can help necessarily.
    </div>
  ...
  <div className='accordion-item'>
   ...
   <h6 id="qn" class="fw-bold">What are the terms and conditions?</h6>
    ...
    <div id="q12" className='accordion-collapse collapse' data-bs-parent="faqs" style={{width:'450px'}}>
      <div className='accordion-body'>
      <p class="ms-4">In order to read and understand our terms and conditions, click  <Link to="/tc" title="link to Ampla Uganda terms and conditions">here</Link>, please. Thank you for choosing Ampla Uganda!</p>
      </div>
    </div>
  </div>
  ...
  <div className='accordion-item'>
   ...
   <h6 id="qn" class="fw-bold">Can I have a look at the privacy policy?</h6>
    ...
    <div id="q13" className='accordion-collapse collapse' data-bs-parent="faqs" style={{width:'450px'}}>
      <div className='accordion-body'>
      <p class="ms-4">Yes ofcourse, you can access the privacy policy by clicking  <Link to="/privacy" title="link to Ampla Uganda privacy policy">here</Link>. Thank you for choosing Ampla Uganda!</p>
      </div>
    </div>
  </div>
