...
const Contact = () => {
  return (
    <div  >
      <div >
          <h1 className="text-center mt-5 text-main">Ampla Uganda</h1>
    <h3 className="text-center">Quick help . Contact us right now</h3>
     <br/><p className="fw-bold text-center"> <Link className="nav-link" to="/signup" > <span className="fw-bold text-primary">Try Ampla Uganda now</span> </Link></p>
    ...
    <p className="fs-3 text-center mb-5">For help about Ampla Uganda concerning sales, technical issues, inquiries, business fit questions, how to use the system, and many more. Reach to us now below.</p>
    ...
    <p className="mt-5">Email: <a href="mailto:support@amplauganda.local">support@amplauganda.local</a></p>
    </div>
  </div>
  </div>
    </div>
