...
// import Img from '../src/images/pslogo.png'
// import signature from '../src/signatures/signature_1.jpg';
...
const useGenerateInvoice = (
  ...
  totals  
    ...
    pdf.setLineHeightFactor(0.2);
     ...
     yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
     pdf.text("Jan 16 2024",calcXPos(pdf,'Jan 16 2024',margin), calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
     yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
     pdf.text(" ",calcXPos(pdf,' ',margin), calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
     yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
     pdf.text("DUE",calcXPos(pdf,'DUE',margin), calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
     yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
     pdf.text("On Receipt",calcXPos(pdf,'On Receipt',margin), calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
     yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
     pdf.text(" ",calcXPos(pdf,' ',margin), calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
     yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
     pdf.text("BALANCE ",calcXPos(pdf,'BALANCE',margin), calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
     yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
     pdf.text('UGX'+totals.balance,calcXPos(pdf,totals.balance,margin), calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
     // add company logo if available
    // pdf.addImage(Img,marginleft,0.5,100/72, 50/72);
    ...
    marginleft = 0.5;
     ...
     yPos = calcVerticalSpacing(9,pdf,yPos+(9/72));
     pdf.text(businessInfo.email,marginleft,calcVerticalSpacing(9,pdf,yPos+(9/72)));
    //line separator
    ...
    pdf.text('BILL TO:',margin, calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
    pdf.setFontSize('13');
    pdf.setLineHeightFactor(0.4)
    yPos1 = calcVerticalSpacing(13,pdf,yPos1+13/72);
    pdf.text(customerInfo.custName,margin, calcVerticalSpacing(13,pdf,yPos1+13/72),{align:'left'});
    yPos1 = calcVerticalSpacing(13,pdf,yPos1+13/72);
    pdf.setFontSize('10');
    pdf.text(' ',margin, calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
    pdf.setTextColor('gray');
    yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
    pdf.text(customerInfo.custAddress,margin, calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
    yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
    pdf.text(customerInfo.custTel_1,margin, calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
    yPos1 = calcVerticalSpacing(10,pdf,yPos1+10/72);
    pdf.text(customerInfo.custEmail,margin, calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
    //line separator
    pdf.setLineWidth(1/72);
    pdf.setDrawColor('black');
    pdf.line(0.5,yPos1+0.5,pageWidth-0.5,yPos1+0.5);
    ...
    content.map((item) => {
        ...
        pdf.text(item.saleQuantity,margin+(descSpan+rateSpan), calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
        pdf.text(item.salePrice*item.saleQuantity,margin+(descSpan+rateSpan+qtySpan+amountLength), calcVerticalSpacing(10,pdf,yPos1+10/72),{align:'left'});
    ...
    pdf.text(totals.totalCost,margin+(descSpan+rateSpan+qtySpan+(amountLength-0.1)), calcVerticalSpacing(13,pdf,yPos1+13/72),{align:'left'});
    ...
    pdf.text('',margin+(descSpan+rateSpan), calcVerticalSpacing(13,pdf,yPos1+13/72),{align:'left'});
    pdf.text('UGX'+totals.balance,margin+(descSpan+rateSpan+qtySpan+(amountLength-0.1)), calcVerticalSpacing(13,pdf,yPos1+13/72),{align:'left'});
    //END LINE
    pdf.setLineWidth(1/72);
    pdf.setDrawColor('black');
    pdf.line(margin+descSpan,yPos1+0.5,pageWidth-0.5,yPos1+0.5);
    ...
    pdf.setFontSize('9');
    pdf.setTextColor('gray');
    // pdf.addImage(signature,'jpg',pageWidth-2,pageHeight-1.7,1,1);
    //signature date stamp
    pdf.text('Signed on',pageWidth-2,(pageHeight-2)+1.5);
    pdf.text('18/1/2024',pageWidth-2,(pageHeight-2)+1.7);
    //SIGNATURE
